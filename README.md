### Update:01/29/2022  As you can see I never did update the diagrams.   However,  This brach has scheduling and offline charts implemented.   The scheduling feature has no safety code.  If you copy a firing and don't change the scheduled firing time, it will start automatically.   I'm going to leave this here but don't recommend using it unless you change it to add some safety protocols.    
