###Update:   12/16/2020   After working great for a year, I started getting two diffent forms of interferece.   The first was voltage fault on the max31856 that cuased the temperature reading to hange.   Not good when your doing a controlled firing.  I'm almost positive this was caused by voltage spike from the relay coils.  The second was that the temperature readings would start dropping after 1150C even though the real temperature was still rising.   After a huge ammount of trouble shooting, I eneded up changing 3 things at once which eleminated both forms of interference.   The three things were 1) add a optoisolation board between the raspbery pi/max31856 control circuit and the relays, 2) remove the max31856 control circuit from the relay box and 3) replace the mechanical relays.  I still haven't isolated the cause of the interference but everything is working again.   I will be updating the wiring schematics after Christmas.   In the meantime, if you have questions feel free to contact me.  You maybe able to avoid both forms of interfence by using solid state relays instead of mechanical.  However, you will need to use heat sinks, probably a fan, and watch them closly for heat issues.   Espcailly if you buy cheap ones.   
